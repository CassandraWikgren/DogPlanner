-- ============================================================
-- FORCE UPDATE: Tvinga uppdatering av trigger-funktioner
-- ============================================================
-- Om verifieringen visar att quantity fortfarande används,
-- kör detta script för att TVINGA fram uppdateringen
-- ============================================================
...
-- Steg 2: Skapa om create_prepayment_invoice() med RÄTT kolumnnamn
...
-- Steg 3: Skapa om create_invoice_on_checkout() med RÄTT kolumnnamn
...
BEGIN
  IF NEW.status = 'checked_out' AND OLD.status != 'checked_out' THEN
    ...
    -- RAD 1: Grundpris - ✅ ANVÄNDER qty och amount
    ...
    -- RAD 2: Tillval - ✅ ANVÄNDER qty och amount
    BEGIN
    ...
    -- RAD 3: Extra services - ✅ ANVÄNDER qty och amount
    ...
    -- RAD 4: Rabatt - ✅ ANVÄNDER qty och amount
...
SELECT 
  ...
  CASE 
    WHEN pg_get_functiondef(p.oid) LIKE '%INSERT INTO invoice_items%qty%' 
     AND pg_get_functiondef(p.oid) NOT LIKE '%INSERT INTO invoice_items%quantity%'
    THEN '✅ KORREKT'
    ELSE '❌ BEHÖVER FIX'
  END as status
FROM pg_proc p
...
-- Om båda visar '✅ KORREKT' är allt fixat!
