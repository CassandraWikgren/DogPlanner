...
export default function ForetagPage() {
  ...
  // Företagssida - För pensionat/dagisägare (B2B)
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <PublicNav currentPage="business" />

      {/* Rest of content is same as before... */}
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-[1600px] mx-auto px-16 sm:px-24 lg:px-32">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <div className="inline-block px-4 py-1 bg-green-100 text-primary rounded-full text-sm font-semibold mb-4">
                🐕 HUNDDAGIS
              </div>
            ...
            <div className="bg-gradient-to-br from-primary to-primary-dark p-8 rounded-2xl shadow-xl">
        ...
        <div className="max-w-[1600px] mx-auto px-16 sm:px-24 lg:px-32">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700 italic">
                "Faktureringen tok typ 5 sekunder istället för 2 timmar. Kan
        ...
        <div className="max-w-[1600px] mx-auto px-16 sm:px-24 lg:px-32">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-8 md:p-12 text-white shadow-2xl">
              ...
              <Link
                href="/register"
                className="block w-full text-center px-8 py-4 bg-white text-primary rounded-lg hover:bg-gray-50 font-bold text-lg transition-all shadow-lg hover:shadow-xl"
              >
                Kom igång gratis nu
              </Link>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary-dark">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Starta gratis idag. Ingen bindningstid, inget krängel.
          </p>
