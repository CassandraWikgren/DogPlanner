    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-gray-600 text-lg">Enligt GDPR Artikel 28</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 pb-8 border-b border-gray-200">
          ...
          <p className="text-gray-700 leading-relaxed">
            Genom att använda DogPlanner godkänner ni detta avtal och bekräftar
            att ni är personuppgiftsansvarig för de personuppgifter som hanteras
            via plattformen.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 ml-6">
                ...
                <li>• Att rapportera säkerhetsincidenter</li>
              </ul>
            </div>
          </div>
        </div>
