                  ...
                  {extraServices.map((service) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            setSelectedExtras((prev) => [...prev, service.id]);
                          } else {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewDogData({ ...newDogData, owner_id: e.target.value })
                    }
                    className="w-full border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                    required
                  >
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-400"
                  >
