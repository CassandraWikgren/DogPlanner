  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-[1600px] mx-auto px-8 sm:px-12 lg:px-16 py-4 flex items-center justify-between">
          <Link
            href="/dashboard"
      ...
      >
        ...
        {/* Content */}
        <div
          className="relative max-w-[1600px] mx-auto px-8 sm:px-12 lg:px-16 py-20 md:py-32"
          style={{
            position: "relative",
            paddingTop: "5rem",
            paddingBottom: "5rem",
