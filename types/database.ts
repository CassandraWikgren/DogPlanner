...
// Booking-typer borttagna tills typfilen är komplett och genererad från Supabase

// Relationsinterface kan definieras separat om det behövs, men ska inte extend:a generiska hjälptyper.
