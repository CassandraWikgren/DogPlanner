    ...
    Tables: {
      ...
      booking_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_events_performed_by_user_id_fkey"
            columns: ["performed_by_user_id"]
            isOneToOne: false
            referencedRelation: "users_without_org"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      consent_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "consent_logs_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users_without_org"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "consent_logs_witness_staff_id_fkey"
