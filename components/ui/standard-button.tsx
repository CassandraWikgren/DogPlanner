...
export function StandardButton({
  ...
  const baseStyles = "inline-flex items-center justify-center font-semibold transition-colors rounded-md focus:outline-none focus:ring-2 focus:ring-[#2c7a4c] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
  
  const variantStyles = {
    primary: "bg-[#2c7a4c] text-white hover:bg-[#236139] shadow-sm",
    secondary: "bg-gray-500 text-white hover:bg-gray-600 shadow-sm",
    outline: "bg-white text-[#2c7a4c] border border-[#2c7a4c] hover:bg-[#E6F4EA]",
