-- ============================================================
-- FINAL FIX: amount är en GENERATED column
-- ============================================================
-- Problemet: amount = qty * unit_price (beräknas automatiskt)
-- Lösning: Ta bort amount från INSERT-satserna
-- ============================================================

-- Steg 1: Radera gamla funktioner
...
-- Steg 2: Skapa create_prepayment_invoice (UTAN amount i INSERT)
...
BEGIN
  IF NEW.status = 'confirmed' AND OLD.status != 'confirmed' THEN
    ...
    -- ✅ FIXED: Använder qty och unit_price, amount beräknas automatiskt
...
-- Steg 3: Skapa create_invoice_on_checkout (UTAN amount i INSERT)
...
BEGIN
  IF NEW.status = 'checked_out' AND OLD.status != 'checked_out' THEN
    ...
    -- RAD 1: Grundpris (amount beräknas från qty * unit_price)
...
SELECT 
  'KLART!' as status,
  'Funktioner uppdaterade - amount beräknas automatiskt från qty * unit_price' as info;

-- Testa nu genom att godkänna en bokning!
